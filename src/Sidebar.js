...
function Sidebar({onViewChange, currentView}){
    ...
    const icons = {
        ...
        database:"M12 2C6.48 2 2 4.02 2 6.5S6.48 11 12 11s10-2.02 10-4.5S17.52 2 12 2zm0 13c-3.1 0-5.96-.63-7.85-1.63A4.3 4.3 0 0 0 2 15.5c0 2.48 4.48 4.5 10 4.5s10-2.02 10-4.5a4.3 4.3 0 0 0-2.15-2.13C17.96 14.37 15.1 15 12 15z m0-4c-3.1 0-5.96-.63-7.85-1.63A4.3 4.3 0 0 0 2 11.5c0 2.48 4.48 4.5 10 4.5s10-2.02 10-4.5a4.3 4.3 0 0 0-2.15-2.13C17.96 10.37 15.1 11 12 11z"
    ...
    return(
        ...
        <div className="sidebar-footer">
            ...
            <div className="footer-links">
                ...
                <button className="footer-btn database" aria-label="Database">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
